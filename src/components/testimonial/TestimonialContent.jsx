        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-5">
            <h2 className="section-title title-center">
              Clients Say About <span>me</span>
            </h2>
          </div>
        </div>
        <div className="row justify-content-center">
                ...
                <SwiperSlide className="single-feedback" key={item.id}>
                  ...
                  <div className="part-txt">
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Alias ab blanditiis pariatur explicabo consequatur ipsam
                      tenetur molestias amet, quos libero vel, modi totam
                      obcaecati dolorem corrupti odio! Praesentium, explicabo
                      excepturi.</p>
                    <h3>{item.name}</h3>
